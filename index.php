...
<section class="content">
    <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col text-center">
                    ...
                    <span class="mt-2">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?= empty($_SESSION['username']) ? '/Login' : '/Recharge'; ?>">
                                <i class="fas fa-money-check-alt mr-1"></i> Nạp Thẻ
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?= empty($_SESSION['username']) ? '/Login' : '/Bank'; ?>">
                    ...
                    <?php
                        ...
                        $recharge_anchor = $recharge_category ?create_anchor_id($recharge_category['title']) : 'recharge_service';
                    ?>
                    <span class="mt-2">
        ...
        ?>
            ...
            <h2 class="guide__title" id="<?=create_anchor_id($category['title'])?>">
                <?=$category['title']?>
            </h2>
                    ...
                    <article class="col-lg-3 col-sm-6 col-6">
                        <div class="genshin-product">
                            <div class="wrapper product-wrapper">
                               <a href="<?=$isRecharge ? '/groups-recharge/'.$group['id'] : '/groups/'.$group['id']?>">
                                ...
                                <div class="genshin-product-footer">
                                   ...
                                   <a href="<?=$isRecharge ? '/groups-recharge/'.toSlug($group['title']) : '/groups/'.toSlug($group['title'])?>">
