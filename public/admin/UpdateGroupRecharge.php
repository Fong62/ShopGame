...
if(!empty($recharge_id)) {
    ...
    if(!$recharge_data) {
        msg_error('Gói nạp không tồn tại', BASE_URL('admin/update-group-recharge/'), 2000);
    }
}
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    if(isset($_POST['update_recharge'])) {
        ...
        if($update) {
            msg_success('Cập nhật gói nạp thành công', BASE_URL('admin/update-group-recharge/'.$group_id), 2000);
        } else {
...
<div class="update-container">
    <div class="update-wrapper">
        ...
        <div class="recharge-id-input">
            ...
            <button onclick="window.location.href='/admin/update-group-recharge/' + document.getElementById('group_select').value" 
                    class="btn-select">
        ...
        <table class="recharge-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/admin/update-group-recharge/<?=$group_id?>/<?=$recharge['id']?>" class="btn-select">
