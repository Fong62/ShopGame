...
<div class="search-container">
    <div class="search-wrapper">
        ...
        <div class="search-id-input">
            <input type="number" id="user_id" class="form-control" placeholder="Nhập ID user" value="<?=$user_id?>" onkeypress="handleKeyPress(event)">
...
<script>
    function searchUser() {
        ...
        if(userId) {
            window.location.href = '/admin/add-money-user/' + userId;
        } else {
