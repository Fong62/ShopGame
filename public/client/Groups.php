        ...
        <div class="col-lg-9">
            <?php if(empty($accounts)): ?>
                <div class="text-center py-4" style="font-size: 1.2rem; background-color: rgba(0,0,0,0.5); border-radius: 10px; color: white; padding: 2rem; margin: 2rem 0;">
                    ...
                    <a href="/groups/<?= @$slug ?>" class="btn btn-outline-warning mt-3" style="font-size: 1.1rem; padding: 0.5rem 2rem;">
                        BỎ LỌC TÌM KIẾM
                    </a>
                </div>
            <?php else: ?>
                        ...
                        <div class="genshin-product">
                            <div class="wrapper product-wrapper">
                                ...
                                <div class="genshin-product-footer">
                                    ...
                                    <a href="/groups/<?=$slug?>/account/<?=$account['id']?>">
                    ...
                    <div class="col-12">
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                ...
                                // Xây dựng chuỗi query parameters (bỏ page hiện tại)
                                $query_params = [];
                                ...
                                $base_url = "/groups/".$slug.($query_string ? '?'.$query_string.'&' : '?');
