                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="profile-details">
                            ...
                            <a href="/change-password" class="action-btn"><i class="fas fa-key"></i> Đổi mật khẩu</a>
                            <a href="/recharge" class="action-btn"><i class="fas fa-money-bill-wave"></i> Nạp tiền</a>
                            <a href="/history" class="action-btn"><i class="fas fa-history"></i> Lịch sử GD</a>
                            <?php if($user['level'] == 'admin'): ?>
                           <a href="#admin" class="action-btn js-admin-tab-btn" style="background: linear-gradient(135deg, #6f42c1, #a37cf0);">
                                <i class="fas fa-cog"></i> Trang quản trị
                            </a>
                            <?php endif; ?>
                            <a href="/logout" class="action-btn" style="background: linear-gradient(135deg, #dc3545, #f0828c);"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="history" role="tabpanel">
                ...
                <?php endforeach; ?>
                    <div class="text-center mt-3">
                        <a href="/history" class="action-btn"><i class="fas fa-list"></i> Xem toàn bộ lịch sử</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="tab-pane fade" id="admin" role="tabpanel">
                ...
                <div class="row text-center">
                    <div class="col-6 col-md-3 mb-3">
                        <a href="/admin/accounts" class="action-btn" style="background: linear-gradient(135deg, #17a2b8, #5bc0de);">
                            <i class="fas fa-users-cog"></i><br>Quản lý tài khoản
                        </a>
                    </div>
                    <div class="col-6 col-md-3 mb-3">
                        <a href="/Admin/AddAccount" class="action-btn" style="background: linear-gradient(135deg, #ffc107, #ffd351); color:#212529;">
                            <i class="fas fa-exchange-alt"></i><br>Thêm tài khoản
                        </a>
                    </div>
                    <div class="col-6 col-md-3 mb-3">
                        <a href="/admin/add-category-group" class="action-btn" style="background: linear-gradient(135deg, #6f42c1, #a37cf0);">
                    ...
                    <div class="col-6 col-md-3 mb-3">
                        <a href="/admin/add-money-user" class="action-btn" style="background: linear-gradient(135deg, #6f42c1, #a37cf0);">
...
$(document).ready(function() {
    // Xử lý khi bấm nút "Trang quản trị"
    $('.js-admin-tab-btn').on('click', function(e) {
        e.preventDefault(); // Ngăn hành vi mặc định
        $('#profileTab a[href="#admin"]').tab('show'); // Hiển thị tab admin
        localStorage.setItem('activeTab', '#admin'); // Lưu vào localStorage
    });

    // Xử lý khi chuyển tab bằng các tab khác
    $('#profileTab a').on('click', function(e) {
        e.preventDefault();
        $(this).tab('show');
        localStorage.setItem('activeTab', $(this).attr('href'));
    ...
    // Khôi phục tab đang active khi tải trang
    var activeTab = localStorage.getItem('activeTab') || '#info';
    $('#profileTab a[href="' + activeTab + '"]').tab('show');
});
</script>
